...
function MenuManager.banniere(id,image,hideTitle,centerTitle,font)
    addToPool(function() TriggerEvent("mfa_menu:banniere",id, image,hideTitle,centerTitle,font); end);
end
